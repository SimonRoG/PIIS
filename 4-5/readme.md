...
У ході виконання лабораторної роботи було продемонстровано можливості використання OpenAI API для автоматичної генерації алгоритмів на Python. Штучний інтелект успішно створив та виконав код для сортування масиву, пошуку простих чисел, а також аналізу та візуалізації даних у DataFrame.
